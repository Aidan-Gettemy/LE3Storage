...
for k = 1:18
    ...
    ExperimentID = "Data/ErosionBlade"+num2str(blade)+"Region"+...
        num2str(mod(k-1,6)+1);
    
    % StatusFileID: This stores which tests have already run
    StatusFileID = "ErosionBlade"+num2str(blade)+"Region"+...
        num2str(mod(k-1,6)+1)+"_Status.txt";
    ...
    % Test Points for Erosion
    test_points = linspace(.5,1,11); % Explore the upper end of the range
